	...
	<div style="overflow: auto;">
		<div class="noscrollbar">
			...
			<div id="bodyContent"><p>{{ $hotel->address }}</p>
				<p>{{ $hotel->category->name }}, {{ $hotel->category->points }} {{ $hotel->brand->points_name }}<span><a class="problem-report-link" href="#" onClick="reportClick(event,{{ $hotel->id }})">Not right?</a></span></p>
			</div>
		</div>
	</div>
</div>